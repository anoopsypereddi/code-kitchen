...
# validation, worktree lease handling, child-worktree protection, and
...
test_fm_home_parameterization() {
  ...
  [ "$out" = "direct-PR off" ] || fail "sc-project-mode did not isolate missing registry by home"
...
test_seed_allows_overlapping_clones_and_drops_owner() {
  ...
  # stays gone. The full happy seed - charter copied, clones+origins,
  # modes preserved - is asserted by sc-secondmate-lifecycle-e2e.

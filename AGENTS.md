...
- 86 immediately - no merge gate. `bin/sc-teardown.sh` allows a prep worktree's scratch commits and dirty files once the tasting notes exist; if the tasting notes are missing, it refuses, because the findings are the work product.
